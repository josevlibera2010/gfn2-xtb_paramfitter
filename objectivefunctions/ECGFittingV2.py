...
class ECGFittingV2:
    """
    Energy Charge Gradient fitting (version 2) class for evaluating
    ...
    def __init__(self, patterns: list, parm: str, out_folder: str, base_names: list[list] = None, paths: list = None,
                 ...
                 scale_factors: tuple = (1.0E+6, 1.0E+6, 1.0E+6), read_hl_curves: bool = True, ref_grad: float = 0.020,
                 ref_ener: float = 10.0):
    ...
    def evaluate(self, thr_id: int, solution: list=None, pfile: bool = False, parm_file: str = None) -> np.array:
        ...
        if pfile and type(parm_file) is str:
            ...
            log += (f'Objective ECGFittingV2 # {thr_id}\n'
                    f'Dir: {curr_dir}\n'
